/**
 * =============================================================================
 * server-ip-rate-limiter.ts — Durable Upstash rate limiting for AI Product Photo Generator
 * =============================================================================
 *
 * PURPOSE:
 ...
 */
const RATE_LIMIT_PREFIX = "ai-product-photo-generator:api-generate:api-generate";
