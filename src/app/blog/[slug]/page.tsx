/**
 * src/app/blog/[slug]/page.tsx — Standalone blog post page (no locale prefix).
 *
 * WHY THIS EXISTS:
 * The primary blog lives at [locale]/blog/[slug]/page.tsx. But next-intl
 * middleware with localePrefix "as-needed" doesn't properly rewrite nested
 * dynamic routes like /blog/slug → /en/blog/slug for the default locale.
 * This standalone route bypasses middleware entirely (blog is excluded from
 * the matcher) and renders the same content directly.
 *
 * All other DD clones use this dual pattern: standalone blog/ + [locale]/blog/.
