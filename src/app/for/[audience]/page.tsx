/**
 * Audience-Specific Landing Page — "Best AI Product Photo Generator for [Audience]"
 *
 * WHY THIS PAGE EXISTS:
 * People searching "best AI product photo generator for Amazon sellers" have a
 * specific identity and specific pain points. A generic landing page ignores their
 * context. This page speaks directly to each audience segment — acknowledging
 * their unique challenges and explaining how PhotoForge AI fits their workflow.
 * This specificity improves both SEO ranking (long-tail keyword match) and
 * conversion (visitors feel understood).
 *
 * ROUTE: /for/[audience]
 * Example: /for/amazon-fba-sellers -> "Best AI Product Photo Generator for Amazon FBA Sellers"
 *
 * SEO STRUCTURE:
 * - Unique <title> targeting "best AI product photo generator for [audience]"
...
function buildAudienceFaqJsonLd(
  ...
  const faqEntries = [
    ...
    },
    {
      ...
      answer: `${productName} offers ${PRODUCT_CONFIG.pricing.free.limit} free product photos per ${PRODUCT_CONFIG.pricing.free.period} with no credit card required. The Pro plan is $${PRODUCT_CONFIG.pricing.pro.price}/mo for unlimited product photo generation.`,
    },
    {
      question: `What problems does ${productName} solve for ${audienceEntry.name.toLowerCase()}?`,
      answer: `${productName} addresses key challenges ${audienceEntry.name.toLowerCase()} face: ${audienceEntry.painPoints.slice(0, 2).join("; ").toLowerCase().replace(/\.$/, "")}. Our AI handles the heavy lifting so you can focus on selling.`,
    },
    {
      question: `How do I get started with ${productName}?`,
      answer: `Getting started is free and takes under 30 seconds. Visit the homepage, sign up, and start generating professional product photos immediately. No credit card required, no software to install.`,
    },
  ];
...
/**
 * buildAudienceHowToJsonLd — HowTo structured data for "how to use [product]
 * for [audience]" queries. Earns step-by-step rich snippets in Google SERPs.
 */
function buildAudienceHowToJsonLd(
  ...
  return {
    ...
    description: `Step-by-step guide for ${audienceLower} to create professional product photos with ${productName}.`,
    totalTime: "PT2M",
    step: [
      {
        "@type": "HowToStep",
        ...
        text: `Visit ${siteUrl} and upload a photo of your product — no account required. ${audienceEntry.name} get free generations daily.`,
      },
      {
        "@type": "HowToStep",
        position: 2,
        name: "Choose a background style",
        text: `Select from professional background styles or describe a custom scene. ${productName} adapts to the needs of ${audienceLower}.`,
      },
      {
        "@type": "HowToStep",
        position: 3,
        name: "Generate AI product photo",
        text: `Click generate and get a professional e-commerce photo in seconds. The AI places your product in a polished setting.`,
      },
      {
        "@type": "HowToStep",
        position: 4,
        name: "Download and list",
        text: `Download your product photo in high resolution. Use it on Amazon, Shopify, Etsy, or any marketplace — commercial use included.`,
      },
    ],
    tool: { "@type": "HowToTool", name: productName, url: siteUrl },
  };
}
...
export default async function AudienceLandingPage({
  ...
  return (
    <>
      ...
      />
      {/* JSON-LD HowTo — step-by-step rich snippets for audience queries */}
      <script
        type="application/ld+json"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-16">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                The Best AI Product Photo Generator for{" "}
              ...
              <p className="mt-6 text-sm text-text-muted">
                {PRODUCT_CONFIG.pricing.free.limit} free product photos per{" "}
            ...
            <section className="mb-16 p-8 rounded-2xl bg-gradient-to-br from-brand-600/10 to-purple-600/10 border border-white/5">
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-4 pt-4">
                  ...
                  <div className="text-center p-4">
                    <p className="text-3xl font-bold text-brand-400 mb-1">
                      ${PRODUCT_CONFIG.pricing.pro.price}
                    </p>
                    <p className="text-sm text-text-muted">
            ...
            <section className="mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  `"Transformed my product photos in 20 seconds — what used to take hours of editing."`,
                  `"Finally, a product photo tool that understands what ${audienceEntry.name.toLowerCase()} actually need."`,
                  `"The free tier let me try it risk-free. Now I use it for every new listing."`,
            ...
            <section className="text-center py-12 px-8 rounded-2xl bg-surface-secondary border border-white/5">
              ...
              <p className="text-text-secondary mb-8 max-w-2xl mx-auto">
                ...
                for professional product imagery. Free to start, no credit card required.
              </p>
              <Link
                href="/login"
