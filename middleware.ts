...
export const config = {
  ...
  matcher: ["/((?!api|_next|_vercel|privacy|privacy-policy|terms|terms-of-service|refund-policy|refund|vs|for|best|use-cases|pricing|blog|lp|testimonials|ai-|get-started|guide|amazon-product-photos|photoroom-alternative|about|.*\\..*).*)"],
};
